...
public class MainTrain {
    ...
    public static void main(String[] args) {        int c=Thread.activeCount();
        GenericConfig gc=new GenericConfig();
        gc.setConfFile("src/main/java/configs/simple.conf"); // change to the exact location where you put the file.
        gc.create();
